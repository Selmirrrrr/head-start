...
#nullable enable
        public async Task<global::HeadStart.Client.Generated.Models.HeadStartWebAPIFeaturesUsersGetMe_Response?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::HeadStart.Client.Generated.Models.HeadStartWebAPIFeaturesUsersGetMe_Response> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::HeadStart.Client.Generated.Models.HeadStartWebAPIFeaturesUsersGetMe_Response>(requestInfo, global::HeadStart.Client.Generated.Models.HeadStartWebAPIFeaturesUsersGetMe_Response.CreateFromDiscriminatorValue, default, cancellationToken).ConfigureAwait(false);
        }
